...
{
    public partial class FrmOPDCheckUPView : Form
    {
        BangnaControl bc;
        int colCode = 1, colNameT = 2, colId = 3, colRow = 0;
        int colCnt = 4;
        public FrmOPDCheckUPView()
        {
            InitializeComponent();
        ...
        private void FrmOPDCheckUPView_Resize(object sender, EventArgs e)
        {
            setResize();
        }
        ...
        {
            FrmOPDCheckUP f = new FrmOPDCheckUP(bc, "");
            f.ShowDialog(this);
        }
        ...
        private void dgvView_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            bc.lw.WriteLog("FrmOPDCheckUPView.dgvView_CellDoubleClick ");
            ...
            FrmOPDCheckUP frm = new FrmOPDCheckUP(bc, dgvView[colId, e.RowIndex].Value.ToString());
            this.Hide();
            frm.ShowDialog();
            this.Show();
            //this.Dispose();
        ...
        private void FrmOPDCheckUPView_Load(object sender, EventArgs e)
        {
