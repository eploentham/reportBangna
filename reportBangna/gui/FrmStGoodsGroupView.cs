...
{
    public partial class FrmStGoodsGroupView : Form
    {
        BangnaControl cc;
        int colRow = 0, colCode = 1, colNameT = 2, colNameE = 3, colRemark = 4, colId = 5;
        int colCnt = 6;
        DataTable dt = new DataTable();
        public FrmStGoodsGroupView(BangnaControl c)
        {
            InitializeComponent();
            initConfig(c);
        }
        ...
        private void dgvView_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            FrmStGoodsGroupAdd frm = new FrmStGoodsGroupAdd(dgvView[colId, e.RowIndex].Value.ToString(), cc);
        ...
        {
            FrmStGoodsGroupAdd frm = new FrmStGoodsGroupAdd("", cc);
            //frm.setControl(dgvView[colId, e.RowIndex].Value.ToString());
            frm.ShowDialog(this);
            setGrd();
        }
